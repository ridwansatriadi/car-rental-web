...
<head>
    ...
    <title> Driver Details || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="driver-details.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="driver-details.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="driver-details.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="driver-details.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="driver-details.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            ...
                            <a href="driver-details.html#"><i class="icon-instagram"></i></a>
                            <a href="driver-details.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="driver-details.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                                <ul class="main-menu__list">
                                    <li class="dropdown megamenu">
                                        <a href="driver-details.html#">Home </a>
                                        <ul>
                                            <li>
                                    ...
                                    <li class="dropdown">
                                        <a href="driver-details.html#">Pages</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="driver-details.html#">Cars</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="driver-details.html#">Shop</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="driver-details.html#">Blog</a>
                                        <ul class="shadow-box">
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="driver-details.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="driver-details.html#">
                            ...
                            <div class="team-details__top-right">
                                <div class="team-details__client-box">
                                    ...
                                    <div class="team-details__social">
                                        <a href="driver-details.html#"><i class="fab fa-twitter"></i></a>
                                        <a href="driver-details.html#"><i class="fab fa-facebook"></i></a>
                                        <a href="driver-details.html#"><i class="fab fa-pinterest-p"></i></a>
                                        <a href="driver-details.html#"><i class="fab fa-instagram"></i></a>
                                    </div>
        ...
        <section class="team-details-contact">
            <div class="container">
                ...
                <div class="team-details-contact__inner">
                    <form class="contact-form-validated team-details-contact__form" action="https://dreamlayout.mnsithub.com/html/gorent/main-html/assets/inc/sendemail.php"
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="driver-details.html#" class="fab fa-twitter"></a>
                    <a href="driver-details.html#" class="fab fa-facebook-square"></a>
                    <a href="driver-details.html#" class="fab fa-pinterest-p"></a>
                    <a href="driver-details.html#" class="fab fa-instagram"></a>
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form action="driver-details.html#">
    ...
    <a href="driver-details.html#" data-target="html" class="scroll-to-target scroll-to-top">
