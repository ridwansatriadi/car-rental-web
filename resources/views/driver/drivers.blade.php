...
<head>
    ...
    <title> Drivers || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="drivers.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="drivers.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="drivers.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="drivers.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="drivers.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="drivers.html#"><i class="icon-facebook"></i></a>
                            <a href="drivers.html#"><i class="icon-twitter"></i></a>
                            <a href="drivers.html#"><i class="icon-instagram"></i></a>
                            <a href="drivers.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="drivers.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                                <ul class="main-menu__list">
                                    <li class="dropdown megamenu">
                                        <a href="drivers.html#">Home </a>
                                        <ul>
                                            <li>
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="drivers.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="drivers.html#">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="500ms"
                        ...
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/team/team-3-5.jpg" alt="">
                                    <div class="team-three__social">
                                        <a href="driver-details.html"><i class="icon-facebook"></i></a>
                                        <a href="driver-details.html"><i class="icon-twitter"></i></a>
                                        <a href="driver-details.html"><i class="icon-linkedin"></i></a>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Jos Brown</a></h3>
                                <p class="team-three__sub-title">SR. Driver</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="600ms"
                        ...
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/team/team-3-6.jpg" alt="">
                                    <div class="team-three__social">
                                        <a href="driver-details.html"><i class="icon-facebook"></i></a>
                                        <a href="driver-details.html"><i class="icon-twitter"></i></a>
                                        <a href="driver-details.html"><i class="icon-linkedin"></i></a>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Kile Jemison</a></h3>
                                <p class="team-three__sub-title">Premium Driver</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="700ms"
                        ...
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/team/team-3-7.jpg" alt="">
                                    <div class="team-three__social">
                                        <a href="driver-details.html"><i class="icon-facebook"></i></a>
                                        <a href="driver-details.html"><i class="icon-twitter"></i></a>
                                        <a href="driver-details.html"><i class="icon-linkedin"></i></a>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Adam Smith</a></h3>
                                <p class="team-three__sub-title">JR. Driver</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="800ms"
                        ...
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/team/team-3-8.jpg" alt="">
                                    <div class="team-three__social">
                                        <a href="driver-details.html"><i class="icon-facebook"></i></a>
                                        <a href="driver-details.html"><i class="icon-twitter"></i></a>
                                        <a href="driver-details.html"><i class="icon-linkedin"></i></a>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Tim Brouce</a></h3>
                                <p class="team-three__sub-title">SR. Driver</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="drivers.html#" class="fab fa-twitter"></a>
                    <a href="drivers.html#" class="fab fa-facebook-square"></a>
                    <a href="drivers.html#" class="fab fa-pinterest-p"></a>
                    <a href="drivers.html#" class="fab fa-instagram"></a>
    ...
    <a href="drivers.html#" data-target="html" class="scroll-to-target scroll-to-top">
