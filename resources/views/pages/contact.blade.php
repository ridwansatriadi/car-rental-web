...
<head>
    ...
    <title> Contact || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="contact.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="contact.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="contact.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="contact.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="contact.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="contact.html#"><i class="icon-facebook"></i></a>
                            <a href="contact.html#"><i class="icon-twitter"></i></a>
                            <a href="contact.html#"><i class="icon-instagram"></i></a>
                            <a href="contact.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="contact.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="contact.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="contact.html#">
                        ...
                        <div class="col-xl-6">
                            <div class="contact-page__right">
                                ...
                                <form id="contact-form" class="contact-form-validated contact-page__form"
                                    action="https://dreamlayout.mnsithub.com/html/gorent/main-html/assets/mail.php" method="POST">
                                    <div class="row">
