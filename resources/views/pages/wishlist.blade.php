...
<head>
    ...
    <title> Wishlist || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="wishlist.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="wishlist.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="wishlist.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="wishlist.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="wishlist.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="wishlist.html#"><i class="icon-facebook"></i></a>
                            <a href="wishlist.html#"><i class="icon-twitter"></i></a>
                            <a href="wishlist.html#"><i class="icon-instagram"></i></a>
                            <a href="wishlist.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="wishlist.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                                <ul class="main-menu__list">
                                    <li class="dropdown megamenu">
                                        <a href="wishlist.html#">Home </a>
                                        <ul>
                                            <li>
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="wishlist.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="wishlist.html#">
            ...
            <div class="container">
                            ...
                            <tr>
                                <td>
                                    <div class="product-box">
                                        <div class="cross-icon">
                                            <a href="wishlist.html"><i class="fas fa-times"></i></a>
                                        </div>
                                        <div class="img-box">
                                            <img src="assets/images/shop/wishlist-page-img-1.jpg" alt="">
                                        </div>
                                        <h3><a href="product-details.html">Fite ON AC_DC Adapter</a></h3>
                                    </div>
                                </td>
                                <td>$120.99</td>
                                <td>In Stock</td>
                                <td>
                                    <div class="product-select">
                                        <a class="thm-btn wishlist-page__btn" href="wishlist.html">
                            ...
                            <tr>
                                <td>
                                    <div class="product-box">
                                        ...
                                        <h3><a href="product-details.html">Gaming Headset</a></h3>
                                    </div>
                                </td>
                                <td>$100.99</td>
                                <td>In Stock</td>
                            ...
                            <tr>
                                <td>
                                    <div class="product-box">
                                        ...
                                        <h3><a href="product-details.html">Wireless Mouse</a></h3>
                                    </div>
                                </td>
                                <td>$106.99</td>
                                <td>In Stock</td>
                            ...
                            <tr>
                                <td>
                                    <div class="product-box">
                                        ...
                                        <h3><a href="product-details.html">Screwdriver and wrench</a></h3>
                                    </div>
                                </td>
                                <td>$170.00</td>
                                <td>In Stock</td>
                ...
                <div class="product-details__social two">
                    ...
                    <div class="product-details__social-link">
                        <a href="wishlist.html#"><span class="fab fa-twitter"></span></a>
                        <a href="wishlist.html#"><span class="fab fa-facebook"></span></a>
                        <a href="wishlist.html#"><span class="fab fa-pinterest-p"></span></a>
                        <a href="wishlist.html#"><span class="fab fa-instagram"></span></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="wishlist.html#" class="fab fa-twitter"></a>
                    <a href="wishlist.html#" class="fab fa-facebook-square"></a>
                    <a href="wishlist.html#" class="fab fa-pinterest-p"></a>
                    <a href="wishlist.html#" class="fab fa-instagram"></a>
    ...
    <a href="wishlist.html#" data-target="html" class="scroll-to-target scroll-to-top">
