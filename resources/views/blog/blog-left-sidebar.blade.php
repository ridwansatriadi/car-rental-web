...
<head>
    ...
    <title> Blog Left Sidebar|| Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="blog-left-sidebar.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="blog-left-sidebar.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="blog-left-sidebar.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="blog-left-sidebar.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="blog-left-sidebar.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="blog-left-sidebar.html#"><i class="icon-facebook"></i></a>
                            <a href="blog-left-sidebar.html#"><i class="icon-twitter"></i></a>
                            <a href="blog-left-sidebar.html#"><i class="icon-instagram"></i></a>
                            <a href="blog-left-sidebar.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="blog-left-sidebar.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                                <ul class="main-menu__list">
                                    <li class="dropdown megamenu">
                                        <a href="blog-left-sidebar.html#">Home </a>
                                        <ul>
                                            <li>
                                    ...
                                    <li class="dropdown">
                                        <a href="blog-left-sidebar.html#">Pages</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="blog-left-sidebar.html#">Cars</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="blog-left-sidebar.html#">Shop</a>
                                        <ul class="shadow-box">
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="blog-left-sidebar.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="blog-left-sidebar.html#">
                    ...
                    <div class="col-xl-4">
                        <div class="sidebar sidebar--two">
                            ...
                            <div class="sidebar__single sidebar__search wow fadeInUp" data-wow-delay=".1s">
                                <form action="blog-left-sidebar.html#" class="sidebar__search-form">
                            ...
                            <div class="sidebar__single sidebar__category wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    ...
                                    <li class="active"><a href="blog-left-sidebar.html#">Parallax Effect
                                            <span>(15)</span></a></li>
                                    <li><a href="blog-left-sidebar.html#">Car rental with driver <span>(08)</span></a></li>
                                    <li><a href="blog-left-sidebar.html#">
                                ...
                                <div class="sidebar__post-box">
                                    <div class="sidebar__post-single">
                                        ...
                                        <div class="sidebar__post-content-box">
                                            <h3><a href="blog-left-sidebar.html#">Regular maintenance cleaning or replacing air filters</a>
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sidebar__post-single">
                                        ...
                                        <div class="sidebar__post-content-box">
                                            <h3><a href="blog-left-sidebar.html#">Water leakage can be due to a clogged drain line repaire</a>
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sidebar__post-single">
                                        ...
                                        <div class="sidebar__post-content-box">
                                            <h3><a href="blog-left-sidebar.html#">Revitalising your people in to a retail downturn.</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sidebar__single sidebar__tags wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <ul class="sidebar__tags-list clearfix list-unstyled">
                                    <li><a href="blog-left-sidebar.html#">Growth Accelerator</a></li>
                                    <li><a href="blog-left-sidebar.html#">Management</a></li>
                                    <li><a href="blog-left-sidebar.html#">Analysis</a></li>
                                    <li><a href="blog-left-sidebar.html#">Planning</a></li>
                                    <li><a href="blog-left-sidebar.html#">Solution</a></li>
                                    <li><a href="blog-left-sidebar.html#">Advisory Service</a></li>
                                </ul>
                            </div>
                            <!--End Sidebar Single-->
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="blog-left-sidebar.html#" class="fab fa-twitter"></a>
                    <a href="blog-left-sidebar.html#" class="fab fa-facebook-square"></a>
                    <a href="blog-left-sidebar.html#" class="fab fa-pinterest-p"></a>
                    <a href="blog-left-sidebar.html#" class="fab fa-instagram"></a>
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form action="blog-left-sidebar.html#">
    ...
    <a href="blog-left-sidebar.html#" data-target="html" class="scroll-to-target scroll-to-top">
