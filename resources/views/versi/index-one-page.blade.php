...
<head>
    ...
    <title> Home One || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="index-one-page.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="index-one-page.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index-one-page.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index-one-page.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index-one-page.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="page-wrapper">
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="index-one-page.html#"><i class="icon-facebook"></i></a>
                            <a href="index-one-page.html#"><i class="icon-twitter"></i></a>
                            <a href="index-one-page.html#"><i class="icon-instagram"></i></a>
                            <a href="index-one-page.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="index-one-page.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                                <ul class="main-menu__list one-page-scroll-menu">
                                    <li class="dropdown megamenu scrollToLink">
                                        <a href="index-one-page.html#home">Home </a>
                                        <ul>
                                            <li>
                                    ...
                                    <li class="scrollToLink">
                                        <a href="index-one-page.html#services">Services</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a href="index-one-page.html#about">About Us</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a href="index-one-page.html#cars">Cars</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a href="index-one-page.html#testimonial">Testimonial</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a href="index-one-page.html#driver">Driver</a>
                                    </li>
                                    <li class="scrollToLink">
                                        <a href="index-one-page.html#blog">Blog</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="index-one-page.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="index-one-page.html#">
        ...
        <!-- Listing One Start -->
        <section class="listing-one" id="cars">
            <div class="container">
                <div class="section-title text-center sec-title-animation animation-style1">
                    <div class="section-title__tagline-box justify-content-center">
                        <div class="section-title__tagline-shape">
        ...
        <!--Team One Start -->
        <section class="team-one" id="driver">
                                                ...
                                                <div class="team-one__buttons-content-box">
                                                    <div class="team-one__buttons-img-box">
                                                        <div class="team-one__buttons-img">
                                                            <img src="assets/images/team/team-one-buttons-img-1-1.jpg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                        ...
                                        <li data-tab="#team-2" class="tab-btn">
                                            <div class="team-one__buttons">
                                                ...
                                                <div class="team-one__buttons-content-box">
                                                    <div class="team-one__buttons-img-box">
                                                        <div class="team-one__buttons-img">
                                                            <img src="assets/images/team/team-one-buttons-img-1-2.jpg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <div class="team-one__buttons-content">
                                        ...
                                        <li data-tab="#team-3" class="tab-btn">
                                            <div class="team-one__buttons">
                                                ...
                                                <div class="team-one__buttons-content-box">
                                                    <div class="team-one__buttons-img-box">
                                                        <div class="team-one__buttons-img">
                                                            <img src="assets/images/team/team-one-buttons-img-1-3.jpg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <div class="team-one__buttons-content">
                                        ...
                                        <li data-tab="#team-4" class="tab-btn">
                                            <div class="team-one__buttons">
                                                ...
                                                <div class="team-one__buttons-content-box">
                                                    <div class="team-one__buttons-img-box">
                                                        <div class="team-one__buttons-img">
                                                            <img src="assets/images/team/team-one-buttons-img-1-4.jpg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <div class="team-one__buttons-content">
                                        ...
                                        <li data-tab="#team-5" class="tab-btn">
                                            <div class="team-one__buttons">
                                                ...
                                                <div class="team-one__buttons-content-box">
                                                    <div class="team-one__buttons-img-box">
                                                        <div class="team-one__buttons-img">
                                                            <img src="assets/images/team/team-one-buttons-img-1-5.jpg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                    <div class="team-one__buttons-content">
                                    ...
                                    <div class="tabs-content">
                                            ...
                                            <div class="team-one__tabs-content-box">
                                                <div class="team-one__img-box">
                                                    <div class="team-one__img">
                                                        <img src="assets/images/team/team-one-1-1.jpg" alt="">
                                        ...
                                        <div class="tab" id="team-2">
                                            <div class="team-one__tabs-content-box">
                                                <div class="team-one__img-box">
                                                    <div class="team-one__img">
                                                        <img src="assets/images/team/team-one-1-2.jpg" alt="">
                                                        <div class="team-one__social">
                                                            <a href="driver-details.html"><span
                                                                    class="icon-facebook"></span></a>
                                                            <a href="driver-details.html"><span
                                        ...
                                        <div class="tab" id="team-3">
                                            <div class="team-one__tabs-content-box">
                                                <div class="team-one__img-box">
                                                    <div class="team-one__img">
                                                        <img src="assets/images/team/team-one-1-3.jpg" alt="">
                                                        <div class="team-one__social">
                                                            <a href="driver-details.html"><span
                                                                    class="icon-facebook"></span></a>
                                                            <a href="driver-details.html"><span
                                        ...
                                        <div class="tab" id="team-4">
                                            <div class="team-one__tabs-content-box">
                                                <div class="team-one__img-box">
                                                    <div class="team-one__img">
                                                        <img src="assets/images/team/team-one-1-4.jpg" alt="">
                                                        <div class="team-one__social">
                                                            <a href="driver-details.html"><span
                                                                    class="icon-facebook"></span></a>
                                                            <a href="driver-details.html"><span
                                        ...
                                        <div class="tab" id="team-5">
                                            <div class="team-one__tabs-content-box">
                                                <div class="team-one__img-box">
                                                    <div class="team-one__img">
                                                        <img src="assets/images/team/team-one-1-5.jpg" alt="">
                                                        <div class="team-one__social">
                                                            <a href="driver-details.html"><span
                                                                    class="icon-facebook"></span></a>
                                                            <a href="driver-details.html"><span
            ...
            <div class="container">
                <div class="brand-one__carousel owl-theme owl-carousel">
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index-one-page.html#"><img src="assets/images/brand/brand-1-1.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index-one-page.html#"><img src="assets/images/brand/brand-1-2.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index-one-page.html#"><img src="assets/images/brand/brand-1-3.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index-one-page.html#"><img src="assets/images/brand/brand-1-4.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index-one-page.html#"><img src="assets/images/brand/brand-1-5.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index-one-page.html#"><img src="assets/images/brand/brand-1-6.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="index-one-page.html#" class="fab fa-twitter"></a>
                    <a href="index-one-page.html#" class="fab fa-facebook-square"></a>
                    <a href="index-one-page.html#" class="fab fa-pinterest-p"></a>
                    <a href="index-one-page.html#" class="fab fa-instagram"></a>
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form action="index-one-page.html#">
    ...
    <a href="index-one-page.html#" data-target="html" class="scroll-to-target scroll-to-top">
