                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="index.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            ...
                            <a href="index.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="index.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="index.html#">
            ...
            <div class="container">
                <div class="brand-one__carousel owl-theme owl-carousel">
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index.html#"><img src="assets/images/brand/brand-1-1.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index.html#"><img src="assets/images/brand/brand-1-2.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index.html#"><img src="assets/images/brand/brand-1-3.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index.html#"><img src="assets/images/brand/brand-1-4.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index.html#"><img src="assets/images/brand/brand-1-5.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index.html#"><img src="assets/images/brand/brand-1-6.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
