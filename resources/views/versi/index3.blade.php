...
<head>
    ...
    <link rel="stylesheet" href="assets/css/module-css/search-car.css" />
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="index3.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="index3.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index3.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index3.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="index3.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="main-menu-three__wrapper-inner">
                        ...
                        <div class="main-menu-three__middle-box">
                            ...
                            <div class="main-menu-three__search-cart-box">
                                <div class="main-menu-three__search-box">
                                    <a href="index3.html#" class="main-menu-three__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu-three__right">
                            ...
                            <div class="main-menu-three__nav-sidebar-icon">
                                <a class="navSidebar-button" href="index3.html#">
                            ...
                            <div class="tab active-tab" id="usedcar">
                                <div class="tabs-content__inner">
                                    <form class="contact-form-validated search-car__form"
                                        action="https://dreamlayout.mnsithub.com/html/gorent/main-html/assets/inc/sendemail.php" method="post" novalidate="novalidate">
                                        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms"
                        ...
                        <div class="services-three__single">
                            ...
                            <div class="services-three__content">
                                <h3 class="services-three__title"><a href="services.html">Corporate car
                                        rental</a>
                                </h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="200ms"
                        ...
                        <div class="services-three__single">
                            ...
                            <div class="services-three__content">
                                <h3 class="services-three__title"><a href="services.html">Car rental with
                                        driver</a>
                                </h3>
                                <p class="services-three__text">Open multipy a green form lesser their from in made herb
                                    multiply</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="300ms"
                        ...
                        <div class="services-three__single">
                            ...
                            <div class="services-three__content">
                                <h3 class="services-three__title"><a href="services.html">Airport transfer</a>
                                </h3>
                                <p class="services-three__text">Open multipy a green form lesser their from in made herb
                                    multiply</p>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="400ms"
                        ...
                        <div class="services-three__single">
                            ...
                            <div class="services-three__content">
                                <h3 class="services-three__title"><a href="services.html">Fleet leasing</a>
                                </h3>
                                <p class="services-three__text">Open multipy a green form lesser their from in made herb
                                    multiply</p>
                            </div>
        ...
        <section class="counter-three">
            ...
            <div class="container">
                <ul class="row list-unstyled">
                    ...
                    <li class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="0ms"
                        data-wow-duration="1500ms">
                ...
                <ul class="list-unstyled pricing-two__list">
                        ...
                        <div class="pricing-two__single">
                            <div class="pricing-two__left-content">
                                <div class="pricing-two__img reveal">
                                    <img src="assets/images/resources/pricing-2-1.png" alt="">
                                </div>
                    ...
                    <li class="wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="pricing-two__single">
                            <div class="pricing-two__left-content">
                                <div class="pricing-two__img reveal">
                                    <img src="assets/images/resources/pricing-2-2.png" alt="">
                                </div>
                                <div class="pricing-two__img-content">
                    ...
                    <li class="wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="pricing-two__single">
                            <div class="pricing-two__left-content">
                                <div class="pricing-two__img reveal">
                                    <img src="assets/images/resources/pricing-2-3.png" alt="">
                                </div>
                                <div class="pricing-two__img-content">
                    ...
                    <li class="wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="pricing-two__single">
                            <div class="pricing-two__left-content">
                                <div class="pricing-two__img reveal">
                                    <img src="assets/images/resources/pricing-2-4.png" alt="">
                                </div>
                                <div class="pricing-two__img-content">
                                        ...
                                        <div class="testimonial-three__client-info">
                                            <div class="testimonial-three__client-content">
                                                <h4 class="testimonial-three__client-name"><a
                                                        href="testimonials.html">Alisa Fox</a></h4>
                                ...
                                <div class="item">
                                    <div class="testimonial-three__single">
                                        ...
                                        <div class="testimonial-three__client-info">
                                            <div class="testimonial-three__client-content">
                                                <h4 class="testimonial-three__client-name"><a
                                                        href="testimonials.html">Robert Son</a></h4>
                                                <p class="testimonial-three__client-sub-title">Founder</p>
                                            </div>
                                        </div>
                                ...
                                <div class="item">
                                    <div class="testimonial-three__single">
                                        ...
                                        <div class="testimonial-three__client-info">
                                            <div class="testimonial-three__client-content">
                                                <h4 class="testimonial-three__client-name"><a
                                                        href="testimonials.html">Danil Aarth</a></h4>
                                                <p class="testimonial-three__client-sub-title">Founder</p>
                                            </div>
                                        </div>
                ...
                <div class="row">
                            ...
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    ...
                                    <div class="team-three__social">
                                        <a href="driver-details.html"><i class="icon-facebook"></i></a>
                                        <a href="driver-details.html"><i class="icon-twitter"></i></a>
                                        <a href="driver-details.html"><i class="icon-linkedin"></i></a>
                                        <a href="driver-details.html"><i class="icon-instagram-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Jessica Brown</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="200ms"
                        ...
                        <div class="team-three__single">
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">James Fuller</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="300ms"
                        ...
                        <div class="team-three__single">
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Jasmet Mangat</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="400ms"
                        ...
                        <div class="team-three__single">
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="driver-details.html">Tim Southe</a></h3>
                                <p class="team-three__sub-title">SR. Driver</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="brand-one__carousel owl-theme owl-carousel">
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index3.html#"><img src="assets/images/brand/brand-1-1.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index3.html#"><img src="assets/images/brand/brand-1-2.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index3.html#"><img src="assets/images/brand/brand-1-3.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index3.html#"><img src="assets/images/brand/brand-1-4.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index3.html#"><img src="assets/images/brand/brand-1-5.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
                    ...
                    <div class="item">
                        <div class="brand-one__single">
                            <div class="brand-one__img">
                                <a href="index3.html#"><img src="assets/images/brand/brand-1-6.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--Brand One Single End-->
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="index3.html#" class="fab fa-twitter"></a>
                    <a href="index3.html#" class="fab fa-facebook-square"></a>
                    <a href="index3.html#" class="fab fa-pinterest-p"></a>
                    <a href="index3.html#" class="fab fa-instagram"></a>
    ...
    <a href="index3.html#" data-target="html" class="scroll-to-target scroll-to-top">
