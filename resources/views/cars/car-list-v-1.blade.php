...
<head>
    ...
    <title> Car List V-1 || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="car-list-v-1.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="car-list-v-1.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="car-list-v-1.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="car-list-v-1.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="car-list-v-1.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="car-list-v-1.html#"><i class="icon-facebook"></i></a>
                            <a href="car-list-v-1.html#"><i class="icon-twitter"></i></a>
                            <a href="car-list-v-1.html#"><i class="icon-instagram"></i></a>
                            <a href="car-list-v-1.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="car-list-v-1.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                                <ul class="main-menu__list">
                                    <li class="dropdown megamenu">
                                        <a href="car-list-v-1.html#">Home </a>
                                        <ul>
                                            <li>
                                    ...
                                    <li class="dropdown">
                                        <a href="car-list-v-1.html#">Pages</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="car-list-v-1.html#">Cars</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="car-list-v-1.html#">Shop</a>
                                        <ul class="shadow-box">
                                    ...
                                    <li class="dropdown">
                                        <a href="car-list-v-1.html#">Blog</a>
                                        <ul class="shadow-box">
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="car-list-v-1.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="car-list-v-1.html#">
                        ...
                        <div class="car-listing-page-one__left">
                            ...
                            <div class="car-listing__pagination">
                                <ul class="pg-pagination list-unstyled">
                                    <li class="prev">
                                        <a href="car-list-v-1.html#" aria-label="prev"><i class="fas fa-angle-left"></i></a>
                                    </li>
                                    <li class="count active"><a href="car-list-v-1.html#">1</a></li>
                                    <li class="count"><a href="car-list-v-1.html#">2</a></li>
                                    <li class="count"><a href="car-list-v-1.html#">3</a></li>
                                    <li class="count"><a href="car-list-v-1.html#">...</a></li>
                                    <li class="next">
                                        <a href="car-list-v-1.html#" aria-label="Next"><i class="fas fa-angle-right"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="car-list-v-1.html#" class="fab fa-twitter"></a>
                    <a href="car-list-v-1.html#" class="fab fa-facebook-square"></a>
                    <a href="car-list-v-1.html#" class="fab fa-pinterest-p"></a>
                    <a href="car-list-v-1.html#" class="fab fa-instagram"></a>
    ...
    <a href="car-list-v-1.html#" data-target="html" class="scroll-to-target scroll-to-top">
