...
<head>
    ...
    <title> Products || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="products.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="products.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="products.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="products.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="products.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="products.html#"><i class="icon-facebook"></i></a>
                            <a href="products.html#"><i class="icon-twitter"></i></a>
                            <a href="products.html#"><i class="icon-instagram"></i></a>
                            <a href="products.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="products.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="products.html#">
                                                            ...
                                                            <div class="single-product-style1">
                                                                <div class="single-product-style1__img">
                                                                    ...
                                                                    <ul class="single-product-style1__info">
                                                                        <li>
                                                                            <a href="products.html#" title="Add to Wishlist">
                                                                                <i class="fa fa-regular fa-heart"></i>
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="products.html#" title="Add to cart">
                                                                                <i class="fa fa-solid fa-cart-plus"></i>
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="products.html#" title="Quick View">
                                                                                <i class="fa fa-regular fa-eye"></i>
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="products.html#" title="Compare">
                    ...
                    <div class="col-xl-3 col-lg-12">
                        <div class="product__sidebar">
                            ...
                            <div class="shop-category product__sidebar-single">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="products.html#">PC Repair</a></li>
                                    <li class="active"><a href="products.html#">Phone Repair</a></li>
                                    <li><a href="products.html#">A/C Installation</a></li>
                                    <li><a href="products.html#">Electrical Wire</a></li>
                                    <li><a href="products.html#">Laptop Repair</a></li>
                                </ul>
                            </div>
                                ...
                                <ul class="clearfix list-unstyled">
                                    <li>
                                        <div class="img">
                                            ...
                                            <a href="products.html#"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                        <div class="content">
                                            <div class="title">
                                                <h5><a href="products.html#">Gree Air Conditioner</a></h5>
                                            </div>
                                            <div class="price">
                                                <p>$33.00</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <div class="title">
                                                <h5><a href="products.html#">Pliers | Cutting, Gripping</a></h5>
                                            </div>
                                            <div class="price">
                                                <p>$39.00</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <div class="title">
                                                <h5><a href="products.html#">Gear and wrench</a></h5>
                                            </div>
                                            <div class="price">
                                                <p>$54.00</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <div class="title">
                                                <h5><a href="products.html#">Nut Driver</a></h5>
                                            </div>
                                            <div class="price">
                                                <p>$44.00</p>
                                            </div>
                            ...
                            <div class="shop-product-tags product__sidebar-single">
                                ...
                                <div class="shop-product__tags-list">
                                    <a href="products.html#">Repair</a>
                                    <a href="products.html#">Technology</a>
                                    <a href="products.html#">Business</a>
                                    <a href="products.html#">Virus</a>
                                    <a href="products.html#">Desktop</a>
    ...
    <a href="products.html#" data-target="html" class="scroll-to-target scroll-to-top">
