...
<head>
    ...
    <title> Cart || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <div class="xs-sidebar-widget">
            <div class="sidebar-widget-container">
                <div class="widget-heading">
                    <a href="cart.html#" class="close-side-widget">X</a>
                </div>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="thm-social-link1">
                                <ul class="social-box list-unstyled">
                                    <li>
                                        <a href="cart.html#"><i class="icon-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="cart.html#"><i class="icon-twitter" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="cart.html#"><i class="icon-linkedin" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="cart.html#"><i class="icon-dribble-big-logo" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="main-menu__top-inner">
                    ...
                    <div class="main-menu__top-right">
                        ...
                        <div class="main-menu__social">
                            <a href="cart.html#"><i class="icon-facebook"></i></a>
                            <a href="cart.html#"><i class="icon-twitter"></i></a>
                            <a href="cart.html#"><i class="icon-instagram"></i></a>
                            <a href="cart.html#"><i class="icon-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="main-menu__wrapper-inner">
                        ...
                        <div class="main-menu__middle-box">
                            <div class="main-menu__main-menu-box">
                                <a href="cart.html#" class="mobile-nav__toggler"><i class="fa fa-bars"></i></a>
                            ...
                            <div class="main-menu__search-cart-box">
                                <div class="main-menu__search-box">
                                    <a href="cart.html#" class="main-menu__search search-toggler icon-search"></a>
                                </div>
                        ...
                        <div class="main-menu__right">
                            ...
                            <div class="main-menu__nav-sidebar-icon">
                                <a class="navSidebar-button" href="cart.html#">
                        ...
                        <div class="cart-page__right">
                            <div class="cart-page__sidebar">
                                <div class="cart-page__shipping">
                                    ...
                                    <form action="cart.html#" class="cart-page__shipping-form">
                                        <div class="row">
                                            <div class="col-xl-12">
                                ...
                                <div class="cart-page__coupon-code">
                                    ...
                                    <form action="cart.html#" class="default-form cart-page__coupon-code-form">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="mobile-nav__top">
                <div class="mobile-nav__social">
                    <a href="cart.html#" class="fab fa-twitter"></a>
                    <a href="cart.html#" class="fab fa-facebook-square"></a>
                    <a href="cart.html#" class="fab fa-pinterest-p"></a>
                    <a href="cart.html#" class="fab fa-instagram"></a>
    ...
    <a href="cart.html#" data-target="html" class="scroll-to-target scroll-to-top">
